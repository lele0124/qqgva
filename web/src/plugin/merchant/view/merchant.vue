...
<template>
  ...
  <el-select v-model="searchInfo.isEnabled" clearable placeholder="请选择">
    ...
    <div class="gva-table-box">
        ...
        <el-table-column sortable align="left" label="日期" prop="CreatedAt" width="180">
            ...
            <el-table-column sortable align="left" label="商户名称" prop="merchantName" width="120" />
            ...
            <el-table-column align="left" label="商户地址" prop="address" width="120" />

            <el-table-column align="left" label="是否启用" prop="isEnabled" width="120">
