...
type SysUser struct {
	...
	Phone         string         `json:"phone"  gorm:"index:idx_phone_not_deleted,unique,condition:deleted_at IS NULL;comment:用户手机号"`                                                                        // 用户手机号
	...
	OperatorId    uint           `json:"operatorId" gorm:"comment:操作者ID"`                                                                     // 操作者ID
	OperatorName  string         `json:"operatorName" gorm:"size:100;comment:操作者姓名"`                                                           // 操作者姓名
}
